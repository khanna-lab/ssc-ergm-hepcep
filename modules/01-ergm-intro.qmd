...
*Running example adapted from Goodreau et al. (2008), "A statnet Tutorial," Journal of Statistical Software 24(9), under CC‑BY.*
...
## Based on the statnet tutorial

![](img/jss-title.png){width="70%" fig-align="center"}

Goodreau, Handcock, Hunter, Butts & Morris (2008). *A statnet Tutorial.*
*Journal of Statistical Software* 24(9) — reused under CC‑BY.
