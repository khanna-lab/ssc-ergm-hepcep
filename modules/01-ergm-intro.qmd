...
- This means that the the log odds of tie probability decay as the
number of common friends increases. 
- A linear scaling WRT to common friends would be specified using a "triangle" parameter, which leads to "model degeneracy" (discussed later). 
- Hence, we use an ERGM parameter that weights the tie probability non-monotonically WRT common friends.  
