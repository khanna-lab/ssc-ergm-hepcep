...
`R/precompute-intro.R`, so the deck renders without re-fitting.
:::
...
## Goodness of fit: degree{.smaller}
...
## Goodness of fit: improved {.smaller}
...
::: {.punch}
Much better — closure was the missing structure.
:::
