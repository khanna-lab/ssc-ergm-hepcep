...
- The `edges` term provides models this baseline probability, akin to the **intercept** in regression modeling.
...
::: notes
(JO: this seems like a big point to make and may require providing intuition about finding configurations in the network space, and how it gets complicated when you go from dyad independent to dependent terms.)
