...
3. **Model** it: null vs. assortative mixing (JO: This is somewhat opaque. Why assortative here?)
...
::: notes
(JO: do these notes go with the slide? It's not immediately clear.) The left-hand side is the observed network; the right-hand side is the terms, which are
