...
- These `nodematch` terms allow us to estimate the probability that persons withing the same grade, or of the same sex or race  are more likely to be friends. 
...
share that attribute. (JO: log likelihood is first introduced here? Will need some at least brief context.) Log-likelihood also jumps (−7790 to −6528): a better fit.
:::
...
::: notes
A converged model is not necessarily a well-aligned one. (JO: what's the intuition behind why this might happen?) We pick a structural property we
