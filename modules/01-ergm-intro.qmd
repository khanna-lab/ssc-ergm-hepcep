...
- We first modeled this using the `ergm` v3.x, part of the `statnet` suite in R. (Add a footnote to this citation? https://pubmed.ncbi.nlm.nih.gov/35020725/, standard bib format)
...
- Once we got the ERGM fitting sequence to work, we wanted to share the decisions we worked through as a pipeline with the ABM community intersted in incorporating empirical networks.
