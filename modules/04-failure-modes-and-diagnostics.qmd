...
- **Degeneracy:** the fitted model puts almost all its probability on a few **extreme graphs** (near-empty
  or near-complete).^[Handcock (2003), CSSS Working Paper 39; Schweinberger (2011), *JASA* 106(496), 1361–1370.]
- Sometimes we see an error; other times the fitting process claims convergence, but the simulated networks are extreme (nearly complete or nearly empty).
