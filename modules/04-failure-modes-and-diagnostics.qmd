...
- **Degeneracy** — no control setting helps → **change the specification**
  (reparameterize; e.g. GWESP, not raw triangles)
- **Poor alignment** — the fit converged → **revisit the spec or the targets**

::: {.punch}
Non-convergence is a *controls* problem; degeneracy and poor alignment are *model* problems.
:::
