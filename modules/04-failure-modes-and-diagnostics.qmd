...
## Non-Convergence: Indicator #3 {.smaller}

The subtlest case: 
- MCMC diagnostics look fine
- GOF may look reasonably **OK but not great**.

- The summary statistics can pass while the network still isn't quite right

- What we found practical: **look at an actual simulated network**, not just the
  GOF output
...
::: {.accent}
When the numbers look fine, comparing a set of simulated networks actually shows whether the structure we care about is reproduced.
:::

::: notes
Experiential point: GOF is a summary; a borderline-OK GOF can still hide structure
that's off. In practice we simulate a network and inspect it directly. Leads into Module 5.
:::

## Non-Convergence: Indicator #3 (Example) {.smaller}
