...
But, there are three ways this can go: 
  ...
  1. MCMC diagnostics and simulated statistics both are good.
  2. MCMC diagnostics: Borderline, Simulated structures <--> Targets align well. 
  3. MCMC diagnostics: Borderline, Simulated structures <--> Targets don't align well. 
...
2. We often care about the simulated network alignment with the targets. If upon repeating the simulation with different seeds, the simulated networks usually contain the targets, we are (arguably) done.
3. Further tune the ERGM controls (Module 3). If necessary, revisit data sources, computation of targets, and assess potential data quality/sampling considerations.     
